...
This repo implements the project's design docs. The design docs are the spec source; this code conforms to them.

## Use the skills

The **Design & Build Skills** are installed. Start with `using-design-skills` to route work across Define → Plan → Build → Ship. Build work runs against a planned `task-NNNNN`; design changes go back to the design repo.
